...
1. **Cyclone Risk Prediction (Linear Regression Model)**  
   ...
   **Dataset**:  
   [Cyclone Dataset](https://www.kaggle.com/datasets/rajumavinmar/cyclone-dataset)
...
2. **Landslide Risk Prediction (LightGBM Model)**  
   ...
   **Dataset**:  
   [Landslide Prediction Dataset](https://www.kaggle.com/datasets/sreeragunandha/landslide-prediction-dataset)
...
3. **Cyclone Intensity Assessment (Deep Learning Model - ResNet-18)**  
   ...
   **Dataset**:  
   [Cyclone Image Dataset](https://www.kaggle.com/datasets/sshubam/insat3d-infrared-raw-cyclone-images-20132021)
...
4. **Flood Detection from Satellite Images (FastAI Image Classification Model)**  
   ...
   **Dataset**:  
   [Flood Dataset](https://www.kaggle.com/datasets/rahultp97/louisiana-flood-2016)
